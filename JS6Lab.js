...
let arrayOfNumbers = [1, 5, 3, 2, 4]      //RM: changed 'const' to 'let' as the variable type
...
class Wallet {
  ...
  addMoney(amount) {
    this.money += amount;                 //RM: added 'this.' to 'money' to reference the variable declared in the constructor
  }
